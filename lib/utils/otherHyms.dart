class OtherHyms{
  ...
  static String allHyms='''223  Crown Him With Many Crowns+
1\n
...
*
NOTE: On the Refrain\n, the men start, the ladies echo, and the
voices join again at the
+'s.
...
Praise Father, Son, and Holy Ghost.''';
  ...
  static List<String> lastHyms= allHyms.split(RegExp(r"\n`"));
